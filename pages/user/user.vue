	...
	<view class="container">
		<view class="top">
			<view class="logo-modular">
				<image class="kf" src="../../static/images/user/icon09.png" @click="openKf"></image>
			...
			<view class="user-modular">
				...
				<view class="user-msg">
					...
					<view class="user-id">
						Account ID: 
						<template v-if="useList.id">{{useList.id}}</template>
		...
		<uni-popup class="state-popup" ref="popupState" @maskClick="close">
			<view class="state-card">
				<image class="state-logo" src="../../static/images/detail/icon06.png" @click="close"></image>
				<view class="state-title">Add Customer Service</view>
				<image class="kf-logo" src="../../static/images/user/icon10.png"></image>
				<view class="kf-des">Contact information</view>
				<view class="kf-tel">(571)888-8888</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			uni.setStorageSync('buy_url', "")
			if(!uni.getStorageSync('token')){
				uni.hideLoading();
				// uni.redirectTo({url:'/pages/register/login'});
				return
			} else if(uni.getStorageSync('coursesUserList')){
		...
		methods: {
			...
			openKf() {
				this.$refs.popupState.open("center")
			},
			close() {
